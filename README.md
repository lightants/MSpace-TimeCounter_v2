...
- Data is stored locally in the browser on that device.
- Use **Export .CSV** for a file, or **Google Sheets** to copy Sheets-ready tab-separated data and open a new sheet for paste.
